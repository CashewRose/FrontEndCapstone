  ...
  AllyHandler = function() {
    ...
    if (this.props.player.allyActive === true) {
      return (<ul className="partner" >
          ...
          <li><Progress isSize='medium' isColor='success' id="Progress2" value={this.props.ally.currentHealth} max={this.props.ally.maxHealth} /></li>
    ...
    return (
      <div className="Stats container">
        <ul>
          ...
          <li><Progress id="Progress1" isSize='medium' isColor='success' value={this.props.player.currentHealth} max={this.props.player.maxHealth} /> </li>
