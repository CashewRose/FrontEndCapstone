      ...
      <div className="AllyContainer">
        ...
        {this.state.allies.map((name, index) => {
            ...
            <div className="AllyPick">
              <img className="allyImg" src={Kiki} alt="A girl is flying on a broom in the sky"></img>
            ...
            return (
            <div className="AllyPick">
              <img className="allyImg" src={Nausicaa} alt="A girl is sitting on an airplane"></img>
              <button id={name.id} className='ally' key={index} onClick={this.DefineCharacters}>{name.name}</button>
            </div>);
            }
            else if (name.id === 3) {
            return (
            <div className="AllyPick">
              <img className="allyImg" src={Mononoke} alt="A girl wearing an animal mask and sporting tribal tattoos"></img>
              <button id={name.id} className='ally' key={index} onClick={this.DefineCharacters}>{name.name}</button>
            </div>);
            }
        })}
